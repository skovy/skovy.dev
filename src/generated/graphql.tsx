...
/** A Gist. */
export type GitHub_Gist = GitHub_Node & GitHub_Starrable & {
...
export type GitHub_PullRequestTimelineItems = GitHub_PullRequestCommit | GitHub_PullRequestReview | GitHub_PullRequestReviewThread | GitHub_BaseRefChangedEvent | GitHub_BaseRefForcePushedEvent | GitHub_DeployedEvent | GitHub_DeploymentEnvironmentChangedEvent | GitHub_HeadRefDeletedEvent | GitHub_HeadRefForcePushedEvent | GitHub_HeadRefRestoredEvent | GitHub_MergedEvent | GitHub_ReviewDismissedEvent | GitHub_ReviewRequestedEvent | GitHub_ReviewRequestRemovedEvent | GitHub_IssueComment | GitHub_CrossReferencedEvent | GitHub_AddedToProjectEvent | GitHub_AssignedEvent | GitHub_ClosedEvent | GitHub_CommentDeletedEvent | GitHub_ConvertedNoteToIssueEvent | GitHub_DemilestonedEvent | GitHub_LabeledEvent | GitHub_LockedEvent | GitHub_MentionedEvent | GitHub_MilestonedEvent | GitHub_MovedColumnsInProjectEvent | GitHub_PinnedEvent | GitHub_ReferencedEvent | GitHub_RemovedFromProjectEvent | GitHub_RenamedTitleEvent | GitHub_ReopenedEvent | GitHub_SubscribedEvent | GitHub_TransferredEvent | GitHub_UnassignedEvent | GitHub_UnlabeledEvent | GitHub_UnlockedEvent | GitHub_UnpinnedEvent | GitHub_UnsubscribedEvent;
...
export type GitHub_SearchResultItem = GitHub_Issue | GitHub_PullRequest | GitHub_Repository | GitHub_User | GitHub_Organization | GitHub_MarketplaceListing;
...
export type GitHub_User = GitHub_Node & GitHub_Actor & GitHub_RegistryPackageOwner & GitHub_RegistryPackageSearch & GitHub_ProjectOwner & GitHub_RepositoryOwner & GitHub_UniformResourceLocatable & GitHub_ProfileOwner & {
  /** Determine if this repository owner has any items that can be pinned to their profile. */
  anyPinnableItems: Scalars['Boolean'],
